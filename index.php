    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-md-6 col-lg-3 text-center mb-4">
          <div class="section_three_img"><img src="images/service/icon1.svg" alt="icon1" class="mb-3"></div>
      ...
      <div class="row section_four_row">
        ...
        <div class="col-12 col-md-8 p-5 section_four_text_side">
          <div class="section_four_text">
              <h3>How to Order</h3>
              <p class="pt-3 pb-3">We believe every event is unique—and so is every menu. That’s why we don’t use online ordering or fixed pricing. Instead, we take all orders directly over the phone. This way, we can:</p>
              <b class="">Understand your exact needs and party size Customize the menu to your preferences Ensure freshness, accuracy, and personal attention</b>
              <h3 class="pt-5 pb-3 custom">Simply give us a call, share your event details, and we’ll create the perfect menu for your gathering.</h3>
          </div>
        </div>
    </div>
  </section>
